...
namespace ActPreciosCarn.Modelos
{
    ...
    public static class ConectionString
    {
        ...
        public static string connMySQL { get; set; }
    }
    ...
    public class Utilerias
    {
        ...
        public static ManejoSql_My EjecutaSQL(string SqlQuery, MySqlCommand cmd)
        {
            ManejoSql_My result = new ManejoSql_My();
        ...
        /// <returns></returns>
        public static ManejoSql_My EjecutaSQL(string SqlQuery, ref int FilasAfectadas, MySqlCommand cmd)
        {
            ManejoSql_My result = new ManejoSql_My();
